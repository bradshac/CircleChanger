...
class CircleChanger(object):
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        halfway = self.circle.center.halfway_to(other_circle_changer.circle.center)
        dist = self.circle.center.get_distance_from(other_circle_changer.circle.center)/2
        return CircleChanger(halfway.x, halfway.y, dist, 'red', self.colors + other_circle_changer.colors)
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.initial
